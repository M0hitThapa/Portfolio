...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <Container className="pt-10 pb-20 relative px-12 bg-white dark:bg-black">
            ...
            <ViewTransition className="space-y-8">
                ...
                <div className="flex gap-4">
                    <Link
                        ...
                        className="inline-flex cursor-pointer items-center gap-2 rounded bg-neutral-950 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-neutral-800 dark:bg-neutral-50 dark:text-neutral-950 dark:hover:bg-neutral-200"
                    >
                        Visit Live Site
                        <svg
                    ...
                    <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex cursor-pointer items-center gap-2 rounded border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-950 transition-colors hover:bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 dark:hover:bg-neutral-900"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
