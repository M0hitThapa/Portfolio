      ...
      <Container className="min-h-[100vh] border-r border-l border-gray-200 p-5 md:pb-8">
        <div className="relative w-full bg-gray-50 px-5">
          ...
          <div
            ...
            style={{
              background: "#FCFCFC", // bg-gray-50
              backgroundImage:
                "radial-gradient(circle at 1px 1px, #EEEEEE 1px, transparent 0)", // neutral-200
              backgroundSize: "10px 10px",
            }}
          />
          <div className="relative flex items-center justify-between pb-8 md:pt-10">
            <Image
              src="/profile.jpeg"
              alt="profile"
              height={140}
            ...
            <div className="relative flex flex-col items-end justify-end">
              <h1 className="text-primary pt-2 pb-1 text-3xl font-bold tracking-tight text-shadow-md md:text-4xl">
                Mohit Thapa
              </h1>
              <p className="shadow-input max-w-lg rounded-md bg-neutral-100 px-2 py-1 font-semibold text-neutral-800 md:text-sm">
                &lt;Design Engineer&gt;
              </p>
              <div className="flex gap-2 pt-2">
                <Link
                  href="/github"
                  className="rounded-md p-1 transition-all duration-300 hover:scale-105 hover:rotate-12 hover:bg-neutral-200"
                >
                  <svg
        ...
        <div className="flex flex-col items-start justify-start pt-2">
          ...
          <p className="text-md text-secondary pt-3 pr-10 font-normal">
